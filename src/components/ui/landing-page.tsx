  ...
  return (
    <div ref={targetRef} className="relative overflow-hidden">
              ...
              <Card className="group h-full overflow-hidden border-teal-500/10 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-teal-500/30 hover:shadow-glow hover:scale-[1.02]">
                <CardContent className="flex h-full flex-col p-6">
                  <div className="mb-4 flex items-center gap-4">
                    ...
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-teal-500/10 text-lg font-bold text-teal-500 transition-transform group-hover:scale-110">
                      {index + 1}
                    </div>
                  </div>
          ...
          <div className="mt-12 flex justify-center">
            <Link to="/documentation">
              <Button
                variant="outline"
                size="lg"
                className="gap-2 group border-teal-500/20 bg-teal-500/5 hover:bg-teal-500/10"
              >
                Learn More
          ...
          <div className="mt-12 flex justify-center">
            <Link to="/tokenomics">
              <Button
                variant="outline"
                size="lg"
                className="gap-2 border-teal-500/20 bg-teal-500/5 hover:bg-teal-500/10 group"
              >
                View Tokenomics
                <ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1" />
              </Button>
      ...
      <section className="container mx-auto px-4 py-20 md:py-28">
        <ScrollReveal>
          <div className="relative overflow-hidden rounded-3xl border border-teal-500/20 bg-gradient-to-r from-teal-500/5 to-cyan-500/10 p-8 shadow-glow-lg md:p-12">
